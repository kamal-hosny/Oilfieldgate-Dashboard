...
const AddProduct = React.memo(() => {
    ...
    return (
        ...
        <div
            className="fixed flex flex-col border-colorBorder top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[6] justify-center items-center rounded-lg w-10/12 bg-sectionColor border-2"
        >
            ...
            <div className="modal-body flex flex-col gap-4 w-full p-3 border-y-2 border-colorBorder">
                ...
                <Loading loading={loading} error={error}>
                    <div className="cards grid grid-cols-2 md:grid-cols-3 gap-4 overflow-y-auto max-h-80">
